...
namespace Pruebaaas.Server.Controllers
{
    ...
    public class CuentasController : ControllerBase
    {
        ...
        [HttpPost("create")]
        public async Task<ActionResult<TokenJwtDto>> CrearUsuario([FromBody] UserDto model)
        {
        ...
        [HttpPost("login")]
        public async Task<ActionResult<TokenJwtDto>> Login([FromBody] UserDto model)
        {
        ...
        private TokenJwtDto BuildToken(UserDto userDto)
        {
